...
<%@page import="com.nagarro.image.models.User"%>
<%@page import="com.nagarro.image.models.Image"%>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="Logout"><span
                        class="glyphicon glyphicon-log-in"><%=username%></span> Logout</a></li>
            </ul>
        </div>
        </nav>
        ...
        <div class="container">
            <form action="ImageUpload" method="post" enctype="multipart/form-data">
                <input type="text" name="imagename" placeholder="Name of image" required>
                <br />
